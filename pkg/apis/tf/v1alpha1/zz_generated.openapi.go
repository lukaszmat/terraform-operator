		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"env": {
						SchemaProps: spec.SchemaProps{
							Description: "Env is used to define a common set of environment variables into the workflow runners. The `TF_VAR_` prefix will also be used by the `exportRepo` option if the `value` is defined. The `exportRepo` option will not add `valueFrom` values.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
